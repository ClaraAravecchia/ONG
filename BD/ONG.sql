...
INSERT INTO HISTORICO_ATENDIMENTO VALUES (99,'2019-04-25','Vacina de raiva','Prazo estimado para a próxima dose em cinco meses.');
INSERT INTO HISTORICO_ATENDIMENTO VALUES (88,'2019-10-23','Castração','Repouso por dois dias.');
INSERT INTO HISTORICO_ATENDIMENTO VALUES (77,'2019-04-04','Gripe de coelho','O animal deve tomar os medicamentos conforme prescrevido.');
SELECT 
    *
FROM
...
INSERT INTO ANIMAL VALUES (600,'Rex','10',null,'Animal com raiva',1,100);
INSERT INTO ANIMAL VALUES (700,'Bob','30',null,'Castração do animal',1,300); 
INSERT INTO ANIMAL VALUES (800,'Lili','20',null,'Gripe',2,200);
INSERT INTO ANIMAL VALUES (900,'Poli','50',null,'Castração',2,500);
SELECT 
    *
FROM
    ANIMAL;
    
INSERT INTO DOACAO VALUES (51,2,'2019-10-30',1);
INSERT INTO DOACAO VALUES (52,5,'2019-10-30',2);
INSERT INTO DOACAO VALUES (53,10,'2019-10-30',2);
INSERT INTO DOACAO VALUES (54,1,'2019-10-29',1);
SELECT 
    *
FROM
    DOACAO;
    
INSERT INTO TIPO VALUES (31,'Pacote de Ração',51);
INSERT INTO TIPO VALUES (32,'Cobertor',52);
INSERT INTO TIPO VALUES (33,'Mordedor',53);
INSERT INTO TIPO VALUES (34,'Aquário',54);
SELECT 
    *
FROM
    TIPO;
...
INSERT INTO COMENTARIO VALUES (81,'Ele é lindo','2019-10-30',null,61);
INSERT INTO COMENTARIO VALUES (82,'Estou interessada. Como faço para adota-lo','2019-10-29',null,62);
SELECT 
    *
FROM
    COMENTARIO;