<?php error_reporting(-1);
	...
	$select  = "SELECT HISTORICO_ATENDIMENTO.DATA_ATENDIMENTO, ANIMAL.NOME AS ANIMAL, VETERINARIO.NOME AS VETERINARIO,     HISTORICO_ATENDIMENTO.MEDICACAO, HISTORICO_ATENDIMENTO.OBSERVACAO 
		...
		function paginacao(b){
			...
			$.ajax({
				...
				data: {
						...
						colunas:{0:"HISTORICO_ATENDIMENTO.DATA_ATENDIMENTO AS DATA",1:"ANIMAL.NOME AS ANIMAL",2:"VETERINARIO.NOME AS VETERINARIO",3:"HISTORICO_ATENDIMENTO.MEDICACAO AS MEDICACAO", 4:"HISTORICO_ATENDIMENTO.OBSERVACAO AS OBSERVACAO"}, 
						pagina: b
					  },
